...
AUTHUD_Siege::AUTHUD_Siege(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	HudWidgetClasses.AddUnique(TEXT("/Script/SiegeGameMode.UTHUDWidget_SiegeStatus"));
	...
	HudWidgetClasses.AddUnique(TEXT("/Script/SiegeGameMode.SiegeScoreboard"));
	HudWidgetClasses.AddUnique(TEXT("/Game/RestrictedAssets/UI/HUDWidgets/bpHW_QuickStats.bpHW_QuickStats_C"));
}

FLinearColor AUTHUD_Siege::GetBaseHUDColor()
{
...
FLinearColor AUTHUD_Siege::GetWidgetTeamColor()
{
